...
/*   Updated: 2022/11/14 18:42:16 by admaupie         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
/*
    ...
    A droite des chevrons se trouve la chaine de caracteres qui fermera le heredoc
...
int	ft_heredoc(char	*end, t_dynarray *darr)
{
    ...
    while (42)
    {
        ...
        tmp->str = buff;
        if (mini_expand(tmp, darr) < 0)// On expand les $arg, ceux ci sont mis en negatif
